...
ESL1G_seLever_mean(:,[1,3:7])=[];ESL1G_seRassoir_mean(:,[1,3:7])=[];
for a=1:1000
    % Se lever
    ...
    VLG_seLever_mean_mean(a,2) = mean(VLG_seLever_mean(a,:))+std(VLG_seLever_mean(a,:))/sqrt(Nb_Young-1);
    VLG_seLever_mean_mean(a,3) = mean(VLG_seLever_mean(a,:))-std(VLG_seLever_mean(a,:))/sqrt(Nb_Young-1);

    ESL1D_seLever_mean_mean(a,1) = mean(ESL1D_seLever_mean(a,:));
    ESL1D_seLever_mean_mean(a,2) = mean(ESL1D_seLever_mean(a,:))+std(ESL1D_seLever_mean(a,:))/sqrt(Nb_Young-1);
    ESL1D_seLever_mean_mean(a,3) = mean(ESL1D_seLever_mean(a,:))-std(ESL1D_seLever_mean(a,:))/sqrt(Nb_Young-1);

    ESL1G_seLever_mean_mean(a,1) = mean(ESL1G_seLever_mean(a,:));
    ESL1G_seLever_mean_mean(a,2) = mean(ESL1G_seLever_mean(a,:))+std(ESL1G_seLever_mean(a,:))/sqrt(Nb_Young-7);
    ESL1G_seLever_mean_mean(a,3) = mean(ESL1G_seLever_mean(a,:))-std(ESL1G_seLever_mean(a,:))/sqrt(Nb_Young-7);
    ...
    VLG_seRassoir_mean_mean(a,2) = mean(VLG_seRassoir_mean(a,:))+std(VLG_seRassoir_mean(a,:))/sqrt(Nb_Young-3);
    VLG_seRassoir_mean_mean(a,3) = mean(VLG_seRassoir_mean(a,:))-std(VLG_seRassoir_mean(a,:))/sqrt(Nb_Young-3);
    ...
    ESL1G_seRassoir_mean_mean(a,2) = mean(ESL1G_seRassoir_mean(a,:))+std(ESL1G_seRassoir_mean(a,:))/sqrt(Nb_Young-7);
    ESL1G_seRassoir_mean_mean(a,3) = mean(ESL1G_seRassoir_mean(a,:))-std(ESL1G_seRassoir_mean(a,:))/sqrt(Nb_Young-7);
...
VLG_seLever_OLD_mean(:,[9:11,13])=[];VLG_seRassoir_OLD_mean(:,[9:11,13])=[];
ESL1D_seLever_OLD_mean(:,[6,12,18])=[];ESL1D_seRassoir_OLD_mean(:,[6,12,18])=[];
ESL1G_seLever_OLD_mean(:,[4,6,18])=[];ESL1G_seRassoir_OLD_mean(:,[4,6,18])=[];
