...
function [rms_cuts, rms_cuts_norm, emg_rms, ...
    ...
    emg_data_filtre_rect_second_lig,tonic_start,tonic_end] = compute_emg_WB(emg_data, Nb_emgs, emg_frequency, ...
    emg_band_pass_Freq, emg_low_pass_Freq, rms_window_step, ...
    onset, offset, emg_div_kin_freq, anticip1, anticip2, emg_ech_norm, duration_tonic, anticip_tonic)
...
for i = 1: Nb_emgs
    ...
    rms_cut = emg_data_filtre_rms((onset*emg_div_kin_freq)-(anticip1*emg_frequency) : (offset*emg_div_kin_freq)+(anticip2*emg_frequency), : );
