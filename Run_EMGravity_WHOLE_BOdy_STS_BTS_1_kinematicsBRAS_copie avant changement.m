...
%%%%% DATA SEQ
        ...
        Donnees_cinematiques_TL.Results_trial_by_trial(i+numel(ListeFichier), 9) = MD_1_V2;
        Donnees_cinematiques_TL.Results_trial_by_trial(i, 10) = rD_PA_1_V2;
        Donnees_cinematiques_TL.Results_trial_by_trial(i+numel(ListeFichier), 10) = rD_PA_2_V2;
        Donnees_cinematiques_TL.Results_trial_by_trial(i, 11) = rD_PV_1_V2;
        Donnees_cinematiques_TL.Results_trial_by_trial(i+numel(ListeFichier), 11) = rD_PV_2_V2;
...
%%%%% DATA SEQ
            ...
            Donnees_cinematiques.Results_trial_by_trial(i+numel(ListeFichier), 9) = MD_1_V2;
            Donnees_cinematiques.Results_trial_by_trial(i, 10) = rD_PA_1_V2;
            Donnees_cinematiques.Results_trial_by_trial(i+numel(ListeFichier), 10) = rD_PA_2_V2;
            Donnees_cinematiques.Results_trial_by_trial(i, 11) = rD_PV_1_V2;
            Donnees_cinematiques.Results_trial_by_trial(i+numel(ListeFichier), 11) = rD_PV_2_V2;
