...
function [EMG_phasique , tonic_meanstd, Vmean_RMS_R, Vmean_RMS_B, norm_tonic_R_moy, norm_tonic_B_moy] = compute_emg2_TonicNew(RMS, RMS_R_norm2, RMS_B_norm2, ...
 emg_frequency, tonic_debut, tonic_fin, Idx, limite_en_temps, signal_mvt_lent_R, signal_mvt_lent_B)   
...
signal_mvt_lent_R_trans_rot = signal_mvt_lent_R_trans * R;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% Partie pour quantifier les desac musculaires sur le phasic combined
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Calculs quantif desac pour le mvt lever
    ...
    amplitude = Pmin * 100 / RMS_R_norm2(indice,i);
    ...
    amplitude2 = Pmin * 100 / RMS_B_norm2(indice,i);
...
%% Enregistrement des données
    ...
    EMG_phasique.QuantifDesac(j, 1) = compteur*MD_MEAN_R(j,1)/emg_frequency;  % Pour l'avoir en temps
    EMG_phasique.QuantifDesac(j, 2) = compteur2*MD_MEAN_B(j,1)/emg_frequency; % Pour l'avoir en temps  
...
% On construit les résultats
    ...
    EMG_phasique.classique.R = emg_phasique_classique_R;
    EMG_phasique.classique.B = emg_phasique_classique_B;

    EMG_phasique.combined.R = emg_phasique_combined_R;
    EMG_phasique.combined.B = emg_phasique_combined_B;

    EMG_phasique.RMS.R = RMS_R_moy_norm;
    EMG_phasique.RMS.B = RMS_B_moy_norm;

    tonic_meanstd.R = tonics_R_meanstd;
    tonic_meanstd.B = tonics_B_meanstd;
